...
<div class="relative">
    <button 
        ...
        data-current-position="{{ Auth::user()->header_position ?? 'top' }}"
    >
        ...
        <div class="p-5">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <button 
                    ...
                    class="flex flex-col items-center justify-center p-5 rounded-lg border-2 transition-all cursor-pointer {{ $headerPosition === 'top' ? 'border-indigo-600 bg-indigo-100 text-indigo-700' : 'border-gray-200 hover:border-indigo-400 hover:bg-indigo-50' }}"
                    style="min-height: 110px;"
                >
                    <svg class="w-10 h-10 mb-3 {{ $headerPosition === 'top' ? 'text-indigo-600' : 'text-gray-600' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <button 
                    ...
                    class="flex flex-col items-center justify-center p-5 rounded-lg border-2 transition-all cursor-pointer {{ $headerPosition === 'bottom' ? 'border-indigo-600 bg-indigo-100 text-indigo-700' : 'border-gray-200 hover:border-indigo-400 hover:bg-indigo-50' }}"
                    style="min-height: 110px;"
                >
                    <svg class="w-10 h-10 mb-3 {{ $headerPosition === 'bottom' ? 'text-indigo-600' : 'text-gray-600' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <button 
                    ...
                    class="flex flex-col items-center justify-center p-5 rounded-lg border-2 transition-all cursor-pointer {{ $headerPosition === 'left' ? 'border-indigo-600 bg-indigo-100 text-indigo-700' : 'border-gray-200 hover:border-indigo-400 hover:bg-indigo-50' }}"
                    style="min-height: 110px;"
                >
                    <svg class="w-10 h-10 mb-3 {{ $headerPosition === 'left' ? 'text-indigo-600' : 'text-gray-600' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <button 
                    ...
                    class="flex flex-col items-center justify-center p-5 rounded-lg border-2 transition-all cursor-pointer {{ $headerPosition === 'right' ? 'border-indigo-600 bg-indigo-100 text-indigo-700' : 'border-gray-200 hover:border-indigo-400 hover:bg-indigo-50' }}"
                    style="min-height: 110px;"
                >
                    <svg class="w-10 h-10 mb-3 {{ $headerPosition === 'right' ? 'text-indigo-600' : 'text-gray-600' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
async function changeHeaderPosition(position) {
    try {
        const response = await fetch('{{ route("preferences.header-position") }}', {
            method: 'POST',
            headers: {
